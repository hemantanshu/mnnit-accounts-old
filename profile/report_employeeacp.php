...
<div class="main">
	<div class="container">
      	<form action="./report_employeeace.php" method="post">
        ...
        <?php 
            ...
            if (sizeof($completeAllowanceIds, 0))
            	...
            	$allowance->palert("Please Select Any AccountHead Type", "./report_employeeac.php");
        ...
        ?>
            ...
            <?php 
            	...
            	foreach ($validMonths as $month){
            		...
            		foreach ($completeAllowanceIds as $allowanceId)
            			echo "  <td align=\"right\">".number_format($reporting->getSalaryAllowanceInfo($employeeId, $month, $allowanceId, false), 2, '.', '')."</td>";
            		echo "</tr>
						  <tr>
						  	<td height=\"5px\"></td>
						  </tr>";
		...
		<table width="100%" align="center">
        	<tr>
      			<td colspan="<?php echo $colspan; ?>" align="center"><br /><br />
                	...
                	<input type="button" value="Get Print Of Report" onclick="window.print()" style="width:250px" />
                    <input type="submit" name="submit" value="Export Data To Excel" style="width:250px" />&nbsp;&nbsp;&nbsp;
                    <input type="button" value="Return Back" onclick="window.location='./report_employeeac.php'" style="width:200px" /></td>      
            </tr>	
            <tr>
            	<td height="50px"></td>
            </tr>
