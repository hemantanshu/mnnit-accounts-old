<?php
    ...
    if(!$allowance->checkLogged())
        $allowance->redirect('../');
    if(isset ($_POST) && $_POST['submit'] == "Clear The Amount For These Employees"){
        ...
        while(true){
            ...
            if(!isset ($_POST[$employeeName]))
                   break;
            $salaryAddition->insertDirectSalary($_POST[$employeeName], $_POST['allowanceId'], 0, $direct);
        }
        $allowance->palert("The Amount For These Employees Have Been Cleared", "./allowance_direct.php?id=".$_POST['allowanceId']."&type=yes");
    }
    if(isset ($_GET)){
        $allowanceId = $_GET['id'];
        if(isset ($_GET['type'])){
    ...
    <div class="main">
      <div class="contentLarge">
      	...
      	<table align="center" border="0" width="100%">
            ...
            <tr>
            	<td colspan="8" align="center"><font class="error">For Allowance Head : <?php echo $allowance->getAllowanceTypeName($allowanceId);?></font><br /><br /><hr size="1" /><br /></td>
            </tr>
            <tr>
                <td colspan="8" height="10px" align="center">
            ...
            <tr>
            	<td colspan="8" height="10px"><hr size="1" /></td>
            </tr>
            <tr>
            	<td colspan="8" align="center">Update The Master Salary &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                
            					<input type="radio" name="option" value="1"  checked="checked"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            									Reflect Direct In The Salary&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            					<input type="radio" name="option" value="0"/></td>
            </tr>
            <tr>
            	<td height="5px" colspan="8"><hr size="1" /></td>
            </tr>
            <tr>
            	<th width="5%">S.N</th>
                ...
                <th width="10%" align="right">S. Amt</th>
                <th width="10%" align="right">C. Amt</th>
                <th width="10%" align="right">Amount</th>
                <th width="10%">Check</th>
                
            </tr>
            <tr>
            	<td height="10px" colspan="8"><hr size="3" /></td>
            </tr>
            <?php
            	$i = 0;
            		...
            		echo "
						<tr>
							...
							<td align=\"right\">0.00
                                                        ...
                                                        <td align=\"center\"><input type=\"checkbox\" name=\"$checkbox\" value=\"1\" checked=\"checked\" />
						</tr>
						<tr>
