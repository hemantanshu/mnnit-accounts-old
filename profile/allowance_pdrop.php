<?php
    ...
    if(count($_POST) > 0 && $_POST['submit'] == "Confirm Dropping Of This Job"){
        ...
        if(!$allowance->isEditable($allowanceId))
                $allowance->palert("This allowance Type Cannot Be Edited ", "./allowance.php");

        if($allowance->dropPendingJob($allowanceId))
                $allowance->palert("The Pending Job Has Been Succesfully Dropped", "./allowance_pending.php");
    ...
    if(isset ($_GET['id'])){
        ...
        $allowance->redirect("./department.php");
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                <td colspan="3" align="center"><font color="#FF0000">Dropping Allowance/Deduction Pending Job </font><hr size="1" /></td>
            </tr>            
            ...
            <?php
                if($allowance->isWorkInPendingStatus($allowanceId)){
                        ...
                        if($allowancePending[0][2] != ""){
                            echo "
                                ...
                                <tr>
                                    ...
                                    <td align=\"center\">".$allowance->getAllowanceTypeName($allowanceId)."</td>
                            ...
                            echo "
                                <tr>
                                    <td colspan=\"3\" align=\"center\"><font class=\"green\">For Allowance Type : ".$allowance->getallowanceTypeName($allowanceId)."</font></td>
                                </tr>
                                </tr>
                                <tr>
                                    <th width=\"30%\"></th>
                        ...
                        for($i =0;$i < $allowancePending[0][0]; ++$i){
                            ...
                            $allowanceDetails = $allowance->getAllowanceDependentDetails($allowancePending[$i][1], true);
                            if($allowancePending[$i][6] == "y"){
                                echo "
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align=\"center\">".$allowancePending[$i][3]."</td>
                                        <td align=\"center\"><font class=\"green\">".$allowanceDetails[3]."</font></td>
                                    </tr>
                                    <tr>
                                        <td height=\"5px\"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align=\"center\">".$allowance->getAllowanceTypeName($allowancePending[$i][4])."</td>
                                        <td align=\"center\"><font class=\"green\">".$allowance->getAllowanceTypeName($allowanceDetails[4])."</font></td>
                                    </tr>
                                    <tr>
                                        <td height=\"5px\"></td>
                                    </tr>
                ...
                ?>
            <tr>
            	<td height="20px"><input type="hidden" name="allowanceId" value="<?php echo $allowanceId; ?>" /></td>
            </tr>
            <tr>
