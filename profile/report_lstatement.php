<?php
    ...
    if($_POST['submit'] == "Process The Loan Statement Request"){
        $employeeId = $_POST['employee'];
        if($_POST['directPrint'] == 'y'){
        	$loggedInfo->redirect("./report_lstatements.php?id=".$employeeId."&type=p");
        }
        $loggedInfo->redirect("./report_lstatements.php?id=".$employeeId."&type=v");
    }    
    ob_end_flush();
?>
...
<head>
<title>Accounts Section -- Employee Loan Statement</title>
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
        	<tr>
            	<td align="center" colspan="3"><font class="error">PLEASE SELECT THE OPTIONS FOR THE LOAN STATEMENT OF EMPLOYEE</font><br /><br /><br /><hr size="2" /><br /><br /></td>
            </tr>
            ...
            <tr>
                ...
                <input type="submit" name="submit" value="Process The Loan Statement Request" style="width:300px" />&nbsp;&nbsp;&nbsp;&nbsp;
