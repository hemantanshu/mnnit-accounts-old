<?php
    ...
    if(!sizeof($completeEmployeeId))
     ...
     foreach ($completeEmployeeId as $employeeId) {
     	...
     	$data[$i][0] = $employeeId;
     	$data[$i][1] = $bank->getBankName($bankDetails[0]);
     	$data[$i][2] = $bankDetails[1];
     	$data[$i][3] = number_format($sum, 2, '.', '');	
     }
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
            <tr>
                <td align="center" colspan="3"><h2>Exporting  Bank Data For <?php echo $accounts->getNumber2Month(substr($date,4,2));?> ,<?php echo substr($date,0,4);?></h2><br /><hr size="2" /><br /></td>
            </tr>
        	<?php 
        		$i = 0;
        		while (true){
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    <input type="button" name="button" value="Print The Slip" onclick="window.location='./salary_vbankp.php?date=<?php echo $date; ?>'" style="width:200px" />&nbsp;&nbsp;&nbsp;
                    <input type="button" name="button" value="Return Back" onclick="window.location='./salary_vbank.php'" style="width:200px" />
