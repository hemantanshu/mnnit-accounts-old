...
if(!sizeof($completeEmployeeId, 1))
	$accountHead->palert("No Employee Record Found For The Given Details", './report_maccountHeada.php');
...
<head>
<title>Employee AccountHead Comparative Statement</title>
...
<div class="main">
	<div class="container">
      	<form action="./report_maccountHeade.php" method="post">
                    ...
                    <table border="0" align="center" width="100%">
                        <tr>
                            ...
                            <td align="center" width="743"><font class="bigheader">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY</font><br /><font class="smallheader">
                                                            ...
                                                            ACCOUNT HEAD REPORT GENERATION </font>
                            </td>
        ...
        <?php 
        	$completeAccountHeadIds = array();        	
        	if(isset($_POST['total']))
        		array_push($completeAccountHeadIds, 'total');
        	$i = 0;
        	while (true){
        		$accountHeadName = "accountHead".$i;
        		++$i;        		
        		if(!isset($_POST[$accountHeadName]))
        			break;
        			
        		array_push($completeAccountHeadIds, $_POST[$accountHeadName]);
        	}        	
        	$colspan = sizeof($completeAccountHeadIds, 0) + 4;
        	
        ?>
      		<tr>
            	<td colspan="<?php echo $colspan; ?>" align="center"><font class="green">ACCOUNT HEAD REPORT OF FOR THE MONTH OF </font><font class="error"><?php echo $accountHead->nameMonth($month); ?></font></td>
            </tr>            
            <tr>
            ...
            <tr>
            	<td colspan="<?php echo $colspan; ?>" align="center">
                	<table border="0" width="100%" align="center">
                    	<tr>                 
                            <td width="5%">Code</td>
                            <td width="28%" align="left">AccountHead Type</td>
                            <td width="5%">Code</td>
                            <td width="28%" align="left">AccountHead Type</td>
                            <td width="5%">Code</td>
                            <td width="*" align="left">AccountHead Type</td>                            
                        </tr>
                        <tr>
                        	<td height="3px"></td>
                        </tr>
                        <?php 
                        	$i = 0;
                        	foreach ($completeAccountHeadIds as $accountHeadId){                        		
                        		$variable = "accountHead".$i;                        		
                        		if($i % 3 == 0 && $i != 0)
                        			echo "</tr><tr>";
                        		elseif($i == 0)
                        			echo "<tr>";
                        		...
                        		if($accountHeadId == 'total')
                        			$accountHeadName = "NET SALARY PAID";
                        		else 
                        			$accountHeadName = strtoupper($accountHead->getAccountHeadName($accountHeadId));
                        		echo "			                        	
			                            <th><input type=\"hidden\" name=\"$variable\" value=\"$accountHeadId\" />".$name."</th>
			                            <td align=\"left\">$accountHeadName</td>";                        		
                        	}
                        	echo "</tr>"
                        ?>                        
                    </table>
            ...
            <?php 
            	...
            	foreach ($completeEmployeeId as $employeeId){
            		...
            		foreach ($completeAccountHeadIds as $accountHeadId)
            			echo "  <td align=\"right\">".number_format($reporting->getSalaryAllowanceInfo($employeeId, $month, $accountHeadId, false), 2, '.', '')."</td>";
            		echo "</tr>
						  <tr>
						  	<td height=\"5px\"></td>
						  </tr>";
		...
		<table width="100%" align="center">
        	<tr>
      			<td colspan="<?php echo $colspan; ?>" align="center">
                    ...
                    <input type="button" value="Return Back" onclick="window.location='./report_maccountheads.php'" style="width:150px" /></td>      
            </tr>	
            <tr>
            	<td height="50px"></td>
            </tr>
