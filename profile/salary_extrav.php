<?php
    ...
    if(!$completeAdditionalSalaryIds)
    ...
    <div class="main">
      <div class="content">
        <table align="center" border="0" width="100%">
        	<tr>
            	<td align="center" colspan="6">Direct Salary Addition For Month Of <font class="green"><?php echo $salaryAddition->getNumber2Month(substr($month, 4, 2)).", ".substr($month, 0, 4); ?></font></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td colspan="6" align="center"><a href="./salary_extrae.php?month=<?php echo $month; ?>" target="_parent">Edit The Details</a>&nbsp;&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <th align="left" width="35%">Account Head</th>
