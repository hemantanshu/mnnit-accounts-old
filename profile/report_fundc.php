		...
		<table border=\"0\" align=\"center\" width=\"100%\">
            ...
            <tr>
                ...
                <td align=\"center\" width=\"*\"><font class=\"bigheader\">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY</font><br /><font class=\"smallheader\">
                                                ...
                                                ACCOUNTS DEPARTMENT -- CPF FUND STATEMENT<br />
...
<head>
<title>Accounts Section -- CPF Annual Summary</title>
      ...
      <div class="contentlarge">          
        <?php            
            foreach($completeEmployeeId as $employeeId){
                $amount =   $interest->getFundAmount($employeeId, "cpf", $startMonth);
                ...
                $interestPaidSubscription = $interest->getFundAmount($employeeId, "cpf", $startMonth, 'im');
                $interestPaidContribution = $interest->getFundAmount($employeeId, "cpf", $startMonth, 'ic');
                
                $openingBalance['s'] = $totalBalanceSubscription = $interest->cpfTotalBalance($employeeId, $startMonth, 'm') + $interestPaidSubscription;
                $openingBalance['c'] = $totalBalanceContribution = $interest->cpfTotalBalance($employeeId, $startMonth, 'c') + $interestPaidContribution;   
                        ...
                        <tr>
                            ...
                            echo "
                                <table align=\"center\" width=\"100%\" border=\"0\" cellpadding=\"5px\" cellspacing=\"5px\">
                                    ...
                                    <tr>
                                        <th width=\"5%\">S.N.</th>
                                        <th align=\"right\" width=\"17%\">Month</th>
                                        <th align=\"right\" width=\"14%\">Subscription</th>
                                        <th align=\"right\" width=\"20%\">Prog. Balance</th>
                                        <th align=\"right\" width=\"1%\"></th>
                                        <th align=\"right\" width=\"14%\">Contribution</th>
                                        <th align=\"right\" width=\"20%\">Prog. Balance</th>
                                        <th align=\"right\" width=\"*\">Interest Rate</th>
                                    </tr>
                                    <tr>
                                        <td colspan=\"9\"><hr size=\"1\" /></td>
                                    </tr>";
                            ...
                            while(true){
                                ...
                                $subscription = $interest->getFundAmount($employeeId, "cpf", $month, 'm');
                                $contribution = $interest->getFundAmount($employeeId, "cpf", $month, 'c');
                                
                                 $interestRate = $interest->getInterestRate($employeeId, $lmonth, 'c');
                                if($month == $startMonth){
                                ...
                                echo "
                                    <tr>
                                        <td align=\"left\">$i</td>
                                        <td align=\"right\">".$interest->nameMonth($showMonth)."</td>
                                        <td align=\"right\">".number_format($subscription, 2, '.', ',')."</td>
                                        <td align=\"right\">".number_format($totalBalanceSubscription, 2, '.', ',')."</td>
                                        <td></td>
                                        <td align=\"right\">".number_format($contribution, 2, '.', ',')."</td>
                                        <td align=\"right\">".number_format($totalBalanceContribution, 2, '.', ',')."</td>
                            ...
                            $interestPaidSubscription = $interest->getFundAmount($employeeId, "cpf", $endMonth, 'm');
                            $interestPaidContribution = $interest->getFundAmount($employeeId, "cpf", $endMonth, 'c');
                            $closingBalanceSubscription = $amount + $interestPaid;
                            $closingBalanceContribution = $amount + $interestPaid;
                                ...
                                <table width=\"100%\" cellpadding=\"0px\" cellspacing=\"0px\" border=\"0px\">
                                   ...
                                   <tr>
									...
									<tr>
                                        ...
                                        <td align=\"center\" width=\"3%\">:</td>
                                        <th align=\"left\" width=\"27%\">".number_format(($interestPaidSubscription+$openingBalance['c']+$totalSubscription), 2, '.', ',')."</th>
                                        <td align=\"right\" width=\"20%\">Balance</td>
                                        <td align=\"center\" width=\"2%\">:</td>
                                    ...
                                    <tr>
                                        <td colspan=\"6\" align=\"left\"><font style=\"font-size: 12px;\">
                                            ** Please Check The Detailed NPS Statement, or Contact Dy. Registrar (Accounts) For Any Clarification</font></td>
                                    </tr>                         
                                    <tr>
                                        <td height=\"20px\"></td>
                                    </tr>
