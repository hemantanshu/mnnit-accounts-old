    ...
    <div class="main">
      <div class="contentLarge">
      	...
      	<table align="center" border="0" width="100%">
            ...
            <tr>
            	<td colspan="7" align="center"><font class="error">For Allowance Head : <?php echo $allowance->getAllowanceTypeName($allowanceId);?></font><br /><hr size="1" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	<th colspan="7" align="center">Reflect Direct In The Salary (Salary Addition Per Month)&nbsp;&nbsp;&nbsp; <?php echo $details[8] == 'c' ? 'EARNING HEAD' : 'DEDUCTION HEAD' ;?>&nbsp;&nbsp;&nbsp;
            					<input type="hidden" name="option" value="0" /></th>
            </tr>         
            <tr>
