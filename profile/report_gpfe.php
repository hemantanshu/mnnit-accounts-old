...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
        ...
        <thead>            
            <tr>
                <td align="center" colspan="3"><h2>SHOWING TOTAL <?php echo strtoupper($fundType)?> BALANCE</h2></td>
            </tr>
        </thead>
            <tbody>
			<?php
					echo "<input type=\"hidden\" name=\"postData00\" value=\"employeeid\" />";    
                    echo "<input type=\"hidden\" name=\"postData01\" value=\"Total Fund Balance\" />";
            	$count = 1; 
            	foreach ($completeEmployeeId as $employeeId){
                    ...
                    echo "<input type=\"hidden\" name=\"postData".$count."1\" value=\"".number_format($amount, 2, '.', '')."\" />";                        
            		++$count;           		            	
            	}
            ?>  
            </tbody>
