        ...
        <table align="center" border="0" width="100%">
			<tr>
            	<td align="center"><font class="green">
            		<font class="error">Motilal Nehru National Institute Of Technology, Allahabad<br />
            		Pay Slip For The Month Of :<?php echo substr($date,4,2);?>  Year :<?php echo substr($date,0,4);?></font>
