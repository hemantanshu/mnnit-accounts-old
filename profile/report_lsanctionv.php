      	...
      	<table align="center" border="0" width="100%">       	
            	...
            	foreach ($completeLoanId as $loanInstallmentId){
            		...
            		echo "
						<tr>
							...
							<td align=\"center\">".$intallmentLeft."</th> 
						</tr>	          
						<tr>
							<td height=\"5px\"></td>
						</tr>";            		
            ...
            <tr>
            	<td colspan="8" align="center"><br />
                        ...
                        <input type="button" style="width:250px" value="Print The Report" onclick="window.location='./report_lsanctionp.php?date=<?php echo $month; ?>'"/>&nbsp;&nbsp;&nbsp;&nbsp;
