...
<head>
<title>Accounts Section -- Salary Consolidated Report For <?php echo $department->getDepartmentName($type);  ?></title>
    ...
    <div class="main">
      <div class="contentlarge">
      	...
      	<table border="0" align="center" width="100%">
            ...
            <tr>
                ...
                <td align="center" width="*"><font class="bigheader">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY</font><br /><font class="smallheader">
                                                ...
                                                ACCOUNTS DEPARTMENT </font><br /><font class="extraSmallheader">CONSOLIDATED REPORT FOR <?php echo strtoupper($department->getDepartmentName($type)); ?></font></td>
        ...
        <table align="center" border="0" width="100%">       	
            ...
            <?php
            	...
            	foreach ($completeAccountHead as $accountHeadId){
            		$amount = $reporting->getDepartmentReportAmount($type, $accountHeadId, $date);
            		if ($amount){
            			$netAmount += $amount;
            			if($amount > 0 ){
            				...
            				if ($accountHeadId == "ACH22") 
            					$collegeContribution[0] += $amount;
            				if ($accountHeadId == "ACH16") 
            					$collegeContribution[1] += $amount;
            	...
            	echo "
            		<tr>
	                	<th style=\"padding-left:150px\" align=\"left\">GROSS SALARY PAID </th>
	                    <th style=\"padding-right:150px\" align=\"right\"><?php echo number_format($grossAmount, 2, '.', ''); ?></th>                    
	                </tr>";
            	echo 
					"<tr>
            	...
            	echo "
            		<tr>
	                    ...
	                    <th style=\"padding-right:150px\" align=\"right\"><?php echo number_format($grossDeduction, 2, '.', ''); ?></th>                    
	                </tr>";
            ?>
            	<tr>
                ...
                <tr>
                	<th style="padding-left:150px" align="left">COLLEGE CONTRIBUTION (NPS)</th>
                    <th style="padding-right:150px" align="right"><?php echo number_format(abs($collegeContribution[0]), 2, '.', ''); ?></th>                    
                </tr>
                <tr>
                	<th height="10px"></th>
                </tr>
                <tr>
                	<th style="padding-left:150px" align="left">COLLEGE CONTRIBUTION (CPF)</th>
                    <th style="padding-right:150px" align="right"><?php echo number_format(abs($collegeContribution[1]), 2, '.', ''); ?></th>                    
                </tr>
                <tr>
                	<th height="10px"></th>
                </tr>
                <tr>
                    ...
                    <th style="padding-right:150px" align="right"><?php
                    												$grossAmount += abs($collegeContribution[0]) + abs($collegeContribution[1]);
                    												 echo number_format($grossAmount, 2, '.', ''); ?></th>                    
                </tr>
                <tr>
                	<td colspan="3"><hr size="3" /></td>
                </tr>            	
                <tr>
                	<th style="padding-left:150px" align="left">TOTAL EMPLOYEE COUNT</th>
                    <th style="padding-right:150px" align="right"><?php echo $reporting->getTotalEmployeeCount($type, false, $date); ?></th>                    
                </tr>
                <tr>
                	<td colspan="3"><hr size="3" /></td>
                </tr>            	
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
            	<th width="25%" align="center">Supt. Accounts</th>
            	<th width="25%" align="center">Dy. Registrar (Accounts)</th>               
                <th width="25%" align="center">Registrar</th>   
                <th width="25%" align="center">Director</th>               
            </tr>            
        </table>
