...
if(isset ($_POST) && count($_POST) > 0){
    if($_POST['submit'] == "View GPF Balance of This Employee Type"){
        $type = "employeeType";
        $value = $_POST['employeeType'];
    }
    if($_POST['submit'] == "View GPF Balance Of This Department"){
        $type = "department";
        $value = $_POST['department'];
    }
    if($_POST['submit'] == "View GPF Balance Of This Designation"){
        $type = "designation";
        $value = $_POST['designation'];
    }
    if($_POST['submit'] == "View GPF Balance Of This Employee"){
        $type = "individual";
        $value = $_POST['employeeId'];
    }
    if($_POST['submit'] == "View GPF Balance Of All Employees"){
        $type = "all";
        $value = $_POST['employee'];
    }
    $fund = $_POST['type'] == "gpf" ? "gpf" : ($_POST['type'] == "cpf" ? "cpf" : "nps");
    
   	$option = $_POST['option'];
   	if($option == 0)
   		$department->redirect("./report_gpfp.php?type=$type&value=$value&option=$fund");
   	elseif ($option == 1)
   		$department->redirect("./report_gpfv.php?type=$type&value=$value&option=$fund");
   	$department->redirect("./report_gpfe.php?type=$type&value=$value&option=$fund");
}
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
                <th colspan="5" align="left" style="padding-left:50px">Select Fund Type: &nbsp;&nbsp;&nbsp;GPF&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="gpf" checked="checked" /> &nbsp;&nbsp;&nbsp;CPF&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="cpf" /> &nbsp;&nbsp;&nbsp;NPS&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="nps" /> </th>
            </tr>
            <tr>
                <td height="10px"></td>
            </tr>
            <tr>
                <th colspan="5" align="left" style="padding-left:50px">View The Summary : &nbsp;&nbsp;&nbsp;<input type="radio" name="option" value="1" checked="checked" /> &nbsp;&nbsp;&nbsp; Print The Summary : &nbsp;&nbsp;&nbsp; <input type="radio" name="option" value="0" />&nbsp;&nbsp;&nbsp; Export To Excel : &nbsp;&nbsp;&nbsp; <input type="radio" name="option" value="-1" /></th>
            </tr>
            <tr>
            	<td height="10px"></td>
            </tr>
            ...
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit"  style="width:250px" value="View GPF Balance of This Employee Type" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View GPF Balance Of This Department" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View GPF Balance Of This Designation" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View GPF Balance Of This Employee" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
                ...
                <td align="left" width="30%">
                        <input type="submit" name="submit" style="width:250px" value="View GPF Balance Of All Employees" /></td>
            </tr>
