...
<head>
<title>Accounts Section -- EmployeeType Information</title>
            ...
            <tr>
            	<td align="center" valign="top">
                	<table border="1" align="center"  >
                    	<tr>
                        	<th width="30px">SN</th>
                            <th width="400px">Employee Type Name</th>
                            ...
                            if(is_array($employeeType->getEmployeeTypeIds(true))){
                                ...
                                foreach ($employeeType->getEmployeeTypeIds(true) as $value){
                                    ...
                                    echo "<tr>
                                            ...
                                            <td align=\"left\"><font class=\"display\">".$employeeType->getEmployeeTypeName($value)."</font></td>
                                ...
                                echo "<tr>
                                        <td colspan=\"6\" align=\"center\"><font class=\"error\">No EmployeeType Record Exists</font></td>
                                    </tr>";
                            }
                        ?>
						<tr>
