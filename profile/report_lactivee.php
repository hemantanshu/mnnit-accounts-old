<?php
    ...
    array_push($data[0], "Loan Type");
    array_push($data[0], "Amount Left");
    array_push($data[0], "Installment Amt");
    array_push($data[0], "Installment Left");
    array_push($data[0], "Closing Month");
    ...
    foreach ($completeLoanId as $loanId){            		
        ...
        array_push($data[$count], $loanDetails[2]);
        array_push($data[$count], number_format($loan->getLoanAmountLeft($loanId, $month), 2, '.', ','));
        array_push($data[$count], number_format($loan->getInstallmentAmount($loanId), 2, '.', ','));
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    <input type="button" name="button" value="Return Back" onclick="window.location='./report_lactive.php'" style="width:200px" />
