...
<head>
<title>Accounts Section -- GPF Active Loan Statement</title>
...
<div class="contentlarge">
      	...
      	<table align="center" border="0" width="100%">       	
        	<tr>
            	<th align="center" colspan="8">SHOWING CURRENT ACTIVE GPF LOAN</th>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="11%" align="right">GPF Balance</td>
            	<td align="right" width="11%">Amount Left</td>
            	<td align="right" width="11%">Inst. Amount</td>            	
            	<td align="right" width="10%">Inst. Left</td>
            	...
            	foreach ($completeLoanId as $loanId){            		
            		...
            		echo "
						<tr>
							...
							<td align=\"right\">".number_format($loan->getEmployeeGpfTotalSum($details[1], $month), 2, '.', ',')."</td>							
							<td align=\"right\">".number_format($loan->getEmployeeGpfLoanAmountLeft($details[1], $month), 2, '.', ',')."</td>
							<td align=\"right\">".number_format($loan->getEmployeeGpfLoanInstallmentAmount($details[1]), 2, '.', ',')."</td>
            ...
            <tr>
            	<td colspan="8" align="center"><br />
                        <input type="button" style="width:250px" value="Print The Report" onclick="window.location='./report_gactivep.php'"/>&nbsp;&nbsp;&nbsp;&nbsp;
