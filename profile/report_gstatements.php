<?php
	...
	if(!$completeGpfIds)
		$loggedInfo->palert("There Is No Record Availiable For The Given Employee. Please Select Another Employee", './report_gstatement.php');    

    $personalInfo->getEmployeeInformation($employeeId, true);
    $flag = true;
    
    if($type == 'p')
    	$url = "./report_gstatementp.php?";
    else 
    	$url = "./report_gstatementv.php?";
...
<head>
<title>Accounts Section -- Employee GPF Loan Statement</title>
            	...
            	if($loanIds){
	            	...
	            	foreach ($loanIds as $loanId){
                        ...
                        <tr>
                            ...
                            <th align=\"center\">:</th>
                            <th align=\"left\">".$gpfTotal->getEmployeeGpfLoanInstallmentLeft($employeeId) * $gpfTotal->getEmployeeGpfLoanInstallmentAmount($employeeId)."</th>
                        </tr>
                        <tr>
                        	<th align=\"center\" colspan=\"6\"><br /><input type=\"button\" value=\"Get Statement Of This Loan\" style=\"width:300px\" onclick=\"window.location='$newurl'\" /></th>
                        </tr>";
	            	}
	            	echo "
				            		</table>
