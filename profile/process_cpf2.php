...
&& isset ($_GET['value'])){
       $employeeId = $_GET['value'];
		...
		if(!$interest->isLastYearProcessed()){
...
if (isset($_POST['submit']) && $_POST['submit'] == "Finalise CPF Account"){
	...
	$interest->finaliseEmployeeCPFAccount($employeeId, $interestRate, true);
	$interest->palert("The CPF Account Has Been Finalised", "./");
}
      ...
      <div class="contentLarge">
        ...
        <table align="center" border="0" width="100%">
            ...
            <?php
            	...
            	$amount = $interest->finaliseEmployeeCPFAccount($employeeId, $interestRate, false); 
            	echo $amount."<br/>";
            	echo "
            		<tr>
		            	<td align=\"center\">
		                ...
		                <td align=\"right\">".$interest->gpfTotalBalance($employeeId, $interest->getCurrentMonth())."</td>
            ...
            <tr>
            	<td colspan="5" align="center">            		
            		...
            		<input type="submit" name="submit" value="Finalise CPF Account" style="width:250px" />
            		<input type="button" value="Return back" onclick="window.location='./process_cpf.php'" style="width:200px" /></td>
            </tr>
        </table>    
        </form>
      </div>
