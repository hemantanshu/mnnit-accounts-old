...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($_POST['submit'] == "View Fake Slip Of This Employee Type"){
        $type = "employeeType";
        $value = $_POST['employeeType'];
    }
    if($_POST['submit'] == "View Fake Slip Of This Department"){
        $type = "department";
        $value = $_POST['department'];
    }
    if($_POST['submit'] == "View Fake Slip Of This Designation"){
        $type = "designation";
        $value = $_POST['designation'];
    }
    if($_POST['submit'] == "View Fake Slip Of This Employee"){
        $type = "individual";
        $value = $_POST['employeeId'];
    }
    if($_POST['submit'] == "View Fake Slip Of All Employees"){
        $type = "all";
    ...
    if($error == 0){
    	$department->redirect("./salary_fakeslip1.php?value=".$value."&type=".$type."");	
    }
      ...
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit"  style="width:250px" value="View Fake Slip Of This Employee Type" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Fake Slip Of This Department" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Fake Slip Of This Designation" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Fake Slip Of This Employee" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Fake Slip Of All Employees" /></td>
            </tr>
