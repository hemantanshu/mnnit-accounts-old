                	...
                	<table align="center" width="100%" border="0">
                        ...
                        <tr>
                        	<td colspan="7" align="center">
                            	...
                            	<input type="button" value="Get The Print Statement" onclick="window.location='report_gstatementp.php?loanid=<?php echo $loanId; ?>'" style="width:200px" />&nbsp;&nbsp;&nbsp;
                                <input type="submit" name="submit" value="Get Output In Excel"  style="width:200px" />&nbsp;&nbsp;&nbsp;
                                <input type="button" value="Return Back" onclick="window.location='./report_gstatement.php'" style="width:150px" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
