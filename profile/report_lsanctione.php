<?php
    ...
    array_push($data[0], "Balance Amt");
    array_push($data[0], "Loan Sanctioned");
    array_push($data[0], "Total Loan Amt");
    array_push($data[0], "Total Installment");
    ...
    foreach ($completeLoanId as $loanInstallmentId){
        ...
        array_push($data[$count], number_format($installmentDetails[2], 2, '.', ''));
