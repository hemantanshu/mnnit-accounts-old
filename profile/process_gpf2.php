...
if (isset($_POST['submit']) && $_POST['submit'] == "Finalise GPF Account"){
	...
	$interest->finaliseEmployeeGPFAccount($employeeId, $interestRate, true);
	$interest->palert("The GPF Account Has Been Finalised", "./");
}
      ...
      <div class="contentLarge">
        ...
        <table align="center" border="0" width="100%">
            ...
            <?php
            	...
            	$amount = $interest->finaliseEmployeeGPFAccount($employeeId, $interestRate, false); 
            	echo "
            		<tr>
		            	<td align=\"center\">
            ...
            <tr>
            	<td colspan="5" align="center">            		
            		...
            		<input type="submit" name="submit" value="Finalise GPF Account" style="width:250px" />
            		<input type="button" value="Return back" onclick="window.location='./process_gpf.php'" style="width:200px" /></td>
            </tr>
        </table>    
        </form>
      </div>
