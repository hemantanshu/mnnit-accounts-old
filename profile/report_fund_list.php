...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($error == 0){
        if($_POST['fundType'] == "GPF")
            $url = "./report_fundg_list.php";
        elseif($_POST['fundType'] == "CPF")
            $url = "./report_fundc_list.php";
        else
            $url = "./report_fundn_list.php";            
      ...
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
                ...
                <td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Annual Statement Of All Employees" />
                </td>
            </tr>    
        </table>
        </form>
