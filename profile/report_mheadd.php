      ...
      <div class="contentlarge">
      	...
      	<table border="0" align="center" width="100%">
            ...
            <tr>
                ...
                <td align="center" width="*"><font class="bigheader">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY</font><br /><font class="smallheader">
                                                ...
                                                ACCOUNTS DEPARTMENT -- ALLOWANCE / DEDUCTION REPORT STATEMENT<br />
        ...
        <table id="myTable" class="tablesorter" width="100%">
        		...
        		foreach ($completeEmployeeId as $employeeId){
        			...
        			echo "
        				<tr>
		                    ...
		                    <th align=\"right\"  style=\"padding-right:20px\">".number_format($credit, 2, '.', '')."</th>
		                    <th align=\"right\"  style=\"padding-right:20px\">".number_format($debit, 2, '.', '')."</th>
		        		</tr>";
        		}
            ...
            <tr>
        		...
        		<tr>
        			...
        			<th align="right" style="padding-right:20px" colspan="2"><?php echo number_format($sum, 2, '.', ''); ?></th>
        		</tr> 
                <tr>
                	<td colspan="5"><hr size="3" /></td>
                </tr>       	          
        ...
        <div id="print" align="center">
        	<table align="center" width="100%">
                <tr>
                    <td align="center"><br />
                        <input type="button" style="width:200px" value="Print The Summary" onclick="window.print() "/>&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="button" style="width:200px" value="Export To Excel" onclick="window.location='report_mheadae.php?id=<?php echo $id;?>&date=<?php echo $month; ?>&type=true'"/>&nbsp;&nbsp;&nbsp;
                        <input type="button" style="width:200px" value="Return Back" onclick="window.location='./report_mhead.php'" /><br />
                    </td>
                </tr>
        </table>
        </div>                 
