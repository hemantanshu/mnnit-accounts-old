...
if(isset($_POST) && $_POST['submit'] == "Process The Report AccountHead Statement"){	
	$sDate = $_POST['syear'].(strlen($_POST['smonth']) == 1 ? '0'.($_POST['smonth']) : $_POST['smonth']);
	if($sDate == "")
		$sDate = $accountHead->getCurrentMonth();
...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
      	<?php 
      		if($option == 'v')
      			echo "<form action=\"./report_maccountheadv.php\" method=\"post\">";
      		else 
      			echo "<form action=\"./report_maccountheadp.php\" method=\"post\">";
      	?>
                	...
                	<table align="center" width="100%" border="0">
                    	<tr>
                        	<td align="left" style="padding-left:50px" colspan="3">
                                ...
                                REPORT FOR THE DATE &nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;<font class="green"><?php echo $accountHead->nameMonth($sDate); ?></font>
                            </td>
                        </tr>
                        <tr>
                        	<td height="10px"></td>
                        ...
                        if($_POST['checkbox'] == 'y')
                        	echo "<tr>
                        			<th align=\"left\"><input type=\"hidden\" name=\"total\" value=\"total\" />Net Salary</th>";
                        else 
                        	echo "<tr>";
                        while (true){
                        	$checkbox = "checkbox".$i;
                        	$accountHeadName = "accountHead".$i;
                        	$newAccountHeadName = "accountHead".$count;
                        	...
                        	if($_POST[$checkbox] == 'y'){
	                        	...
	                        	if($count % 3 == 0)
	                        		echo "
	                        			...
	                        			<tr>";
	                        	$accountHeadId = $_POST[$accountHeadName];
	                        	echo "<th align=\"left\"><input type=\"hidden\" name=\"$newAccountHeadName\" value=\"$accountHeadId\" />".$accountHead->getAccountHeadName($accountHeadId)."</th>";	
                        	}                        	
                        }
                        echo "</tr>";
                        ?>          
