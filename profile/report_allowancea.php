...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if ($option == 'p')
    	$allowance->redirect("./report_allowancep.php?sdate=$sDate&edate=$eDate&id=$allowanceId&type=$type&value=$value");
    else 
    	$allowance->redirect("./report_allowancev.php?sdate=$sDate&edate=$eDate&id=$allowanceId&type=$type&value=$value");
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
        	<tr>
            	<td align="center" colspan="5"><font size="+1">For Allowance Type :<b><?php echo $allowanceId == "total" ? 'Total Salary' :($allowanceId == "gross" ? "Gross Salary" : ($allowanceId == "deduction" ? "Total Deduction" : $allowance->getAllowanceTypeName($allowanceId)));?></b> And Option Selected <b><?php echo $type == 'v' ? "VIEW REPORT" : ($type == 'p' ? "PRINT REPORT" : "EXPORT TO EXCEL"); ?></b><br /> From <b><?php echo $allowance->nameMonth($sDate); ?></b> To <b><?php echo $allowance->nameMonth($eDate); ?></b></font></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" width="30%">
                        ...
                        <input type="hidden" name="allowance" value="<?php echo $allowanceId; ?>" />
