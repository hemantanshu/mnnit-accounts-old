...
if (isset($_POST['submit']) && $_POST['submit'] == "Process NPS Interest"){
	...
	while (true){
		...
		$amount = $interest->getTotalNPSInterest($employeeId, $interestRate, $sessionDetails, true, 'm');
                $amount = $interest->getTotalNPSInterest($employeeId, $interestRate, $sessionDetails, true, 'c');
		++$i;
	}
	$interest->palert("The NPS Interest Has Been Applied", "./");
}
...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="contentLarge">
        ...
        <table align="center" border="0" width="100%">
         	 <tr>
                ...
                <th align="right">GPF Amt(Subs)</th>
                <th align="right">Interest</th>
                <th align="right">NPS Amt(Cont.)</th>
                <th align="right">Interest</th>
            </tr>          
            <tr>
            ...
            <?php 
            	...
            	foreach ($completeEmployeeId as $employeeId){            		
            		$amount = $interest->getTotalNPSInterest($employeeId, $interestRate, $sessionDetails, false, 'm');            		            		
            		if (!$amount || $amount == 0)
            			continue;            		
            		$employeeName = "employee".$i;
            		++$i;
            		...
            		<tr>
		                ...
		                <td align=\"right\">".  number_format($interest->npsTotalBalance($employeeId, $sessionDetails[2], 'm'), 2, '.', '')."</td>
		                <td align=\"right\">".number_format($amount, 2, '.', '')."</td>
                                <td align=\"right\">".  number_format($interest->npsTotalBalance($employeeId, $sessionDetails[2], 'c'), 2, '.', '')."</td>
		                <td align=\"right\">".number_format($interest->getTotalNPSInterest($employeeId, $interestRate, $sessionDetails, false, 'c'), 2, '.', '')."</td>    
		            </tr>";            		
            	}
            ?>
            <tr>
      ...
      <input type="submit" name="submit" value="Process NPS Interest" style="width:250px" />
            		<input type="button" value="Return back" onclick="window.location='./process_interest.php'" style="width:200px" />
</form>      
      <div class="clearer"><span></span></div>
    </div>
