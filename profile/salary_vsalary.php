<?php
    ...
    if($_POST['submit'] == "View Employee Salary Slip"){
        $month = $_POST['month'];
        $year = $_POST['year'];
        ...
        $loggedInfo->redirect("./salary_vsalaryv.php?id=".$employeeId."&date=".$date."");
    }
      ...
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                ...
                <td width="20px"></td>
                <td align="left">
                			<select name="employeeId" style="width:200px">
                                       <?php
            ...
            <tr>
            	<td colspan="3" align="center"><br /><br /><input type="submit" name="submit" value="View Employee Salary Slip" /><br /><br /></td>
            </tr>
        </table>
        </form>
      </div>
