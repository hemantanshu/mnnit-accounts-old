...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($_POST['submit'] == "UnBlock Salary Of This Employee Type"){
        $type = "employeeType";
        $value = $_POST['employeeType'];
    }
    if($_POST['submit'] == "UnBlock Salary Of This Department"){
        $type = "department";
        $value = $_POST['department'];
    }
    if($_POST['submit'] == "UnBlock Salary Of This Designation"){
        $type = "designation";
        $value = $_POST['designation'];
    }
    if($_POST['submit'] == "UnBlock Salary Of This Employee"){
        $type = "individual";
        $value = $_POST['employeeId'];
    }
    if($_POST['submit'] == "UnBlock Salary Of All Employees"){
        $type = "all";
    ...
    if($error == 0){
        $department->redirect("./salary_unblocks.php?value=".$value."&type=".$type."");
    }
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
            <tr>
            	<td align="center" colspan="5"><font class="green">Employee Salary UnBlocking Module</font><br /><hr size="3" /><br /><br /></td>
            </tr>
            <?php
            ...
            <tr>
            	...
            	<td width="2%"></td>                                
                <td align="left" width="30%"><input type="submit" name="submit"  style="width:275px" value="UnBlock Salary Of This Employee Type" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="2%"></td>                                
                <td align="left" width="30%"><input type="submit" name="submit" style="width:275px" value="UnBlock Salary Of This Department" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>                                
                <td align="left" width="30%"><input type="submit" name="submit" style="width:275px" value="UnBlock Salary Of This Designation" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
                ...
                <td align="left" width="35%">
                                            <select name="employeeId" style="width:225px">
                                                <option value="">--Select--</option>
                                                <?php
                                                    $employeeId = $employeeInfo->getEmployeeIds(true, 'block');
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:275px" value="UnBlock Salary Of This Employee" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:275px" value="UnBlock Salary Of All Employees" /></td>
            </tr>
