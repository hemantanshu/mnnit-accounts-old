        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                <td width="100%">
                    <table align="center" width="100%" border="0">
                        ...
                        <?php
                            $i = 0;
                            foreach ($completeActiveEmployee as $employeeId){
                                $employeeName = "employee".$i;
                                $amountName = "amount".$i;
                                ++$i;
                                $personalInfo->getEmployeeInformation($employeeId, true);
                                $employeeType = $personalInfo->getEmployeeType();
                                
                                echo "
                                    <tr>
                                        <th><input type=\"hidden\" name=\"$employeeName\" value=\"$employeeId\" />".$personalInfo->getEmployeeCode()."</th>
                                        <th align=\"left\">".$personalInfo->getName()."</th>
                                        <th align=\"left\">".$department->getDepartmentName($personalInfo->getDepartment())."</th>
                                        <th><input type=\"text\" name=\"$amountName\" style=\"width:100px\" /></th>
                                    </tr>
                                    <tr>
                                        <td height=\"10px\"></td>
                                    </tr>";
            ...
            <tr>
            	<td colspan="3" align="center">
                    <input type="submit" name="submit" value="CONFIRM SANCTION OF BULK LOAN" style="width:300px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
