...
<head>
<title>Accounts Section -- GPF Active Loan Account Information</title>
    ...
    <div class="main">
      <div class="content">
      	<table align="center" border="0" width="100%">
            ...
            <tr>
            	<td height="10px" align="center"><h1 class="error">ACTIVE GPF LOAN ACCOUNTS</h1></td>
            </tr>
            <tr>
                        	...
                        	foreach ($completeLoanId as $loanId){
                        		...
                        		echo "
									<tr>
										...
										<th style=\"padding-right:5px\" align=\"right\">".number_format($details[2], 2, '.', '')."</th>
										<th align=\"center\"><a href=\"./gpf_loanstatementv.php?loanid=".$loanId."\" target=\"_parent\"><img src=\"../img/b_props.png\" alt=\"view\" /></a></th>
										<th align=\"center\"><a href=\"#\"  onclick=\"loadPHPFile('gpf_info.php?loanid=".$loanId."')\"><img src=\"../img/b_browse.png\" alt=\"info\" /></a></th>
