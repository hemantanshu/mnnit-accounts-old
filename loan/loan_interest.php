...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
      	<form action="./loan_interest1.php" method="post">
      	<table align="center" border="0" width="100%">
        	<!-- insertion of new departments will be done here -->
            <tr>
            	<td height="10px" align="center"><h1 class="error">Interest On Loan</h1></td>
            </tr>
            <tr>
                	...
                	<table border="0" align="center" width="100%">
                        	...
                        	foreach ($completeLoanId as $loanId){
                        		...
                        		echo "
									<tr>
										...
										<th align=\"right\">".number_format($loan->getLoanPrincipleAmountLeft($loanId, $loan->getCurrentMonth()), 2, '.', '')."</th>
										<th align=\"right\">$details[6]%</th>
										<th align=\"center\">
											<input type=\"checkbox\" name=\"$checkboxName\" checked=\"checked\" value=\"y\" />
											<input type=\"hidden\" name=\"$loanIdName\" value=\"$loanId\" /></th>									
									</tr>
									<tr>
										<td height=\"10px\"></td>
									</tr>";
                        ...
                        <tr>
                            <td colspan="8" align="center"><br /><br />
                            	<input type="submit" name="submit" value="Get Interest On These Loans" style="width:300px" />
                            	</td>
                        </tr>
                    </table>
                </td>
