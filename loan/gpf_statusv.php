<?php
    ...
    if(!$completeLoanId)
    	$loan->palert("No GPF Loan Statement Record Exists For The Given Month.", './loan_status.php');    
            	...
            	foreach ($completeLoanId as $loanInstallmentId){
            		...
            		echo "
						<tr>
							...
							<th align=\"right\">".number_format($loan->getEmployeeGpfLoanAmountLeft($loanDetails[1], $month), 2, '.', '')."</th>
							<th align=\"right\" style=\"padding-right:15px\">".$loan->getEmployeeGpfLoanInstallmentLeft($loanDetails[1], $month)."</th>                
						</tr>	          
						<tr>
							<td height=\"5px\"></td>
						</tr>";            		
