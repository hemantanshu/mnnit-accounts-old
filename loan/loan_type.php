    ...
    <div class="main">
      <div class="content">
      	<table align="center" border="0" width="100%">
            ...
            <tr>
            	<td height="10px" align="center"><h1 class="error">LOAN TYPES</h1></td>
            </tr>
            <tr>
            	...
            	<td align="center" valign="top">
                	<table border="1" align="center" width="100%">
                    	<tr>
                            <th width="5%">SN</th>
                            <th width="25%">Name</th>
                            <th width="25%">Allowance Map</th>
                            <th width="8%">Max Amount</th>
                            <th width="8%">Max Installment</th>                            
                            <th width="7%">Info</th>
                            <th width="7%">Edit</th>
                            <th width="7%">Info</th>
                            <th width="7%">Drop</th>
                        	...
                        	foreach ($completeLoanId as $loanId){
                        		...
                        		echo "
									<tr>
										...
										<th align=\"left\">".$details[2]."</th>
										<th align=\"left\">".$allowance->getAllowanceTypeName($details[1])."</th>
										<th align=\"center\">$details[3]</th>
										<th align=\"center\">$details[4]</th>
										<th align=\"center\"><a href=\"./loan_view.php?id=".$loanId."\" target=\"_parent\"><img src=\"../img/b_props.png\" alt=\"view\" /></a></th>
										<th align=\"center\"><a href=\"./loan_typee.php?id=".$loanId."\" target=\"_parent\"><img src=\"../img/b_edit.png\" alt=\"edit\" /></a></th>
