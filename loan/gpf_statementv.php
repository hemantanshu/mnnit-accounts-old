                	...
                	<table align="center" width="100%" border="0">
                        ...
                        <tr>
                        	<td colspan="7" align="center">
                            	<input type="button" value="Get The Print Statement" onclick="window.location='gpf_statementp.php?id=<?php echo $employeeId; ?>'" style="width:200px" />&nbsp;&nbsp;&nbsp;
                                <input type="button" value="Get Output In Excel" onclick="window.location='gpf_statemente.php?id=<?php echo $employeeId; ?>'" style="width:200px" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
