<?php
    ...
    include_once '../include/class.remarks.php';
    ...
    if(!$accounts->checkEmployeeLogged())
        $accounts->redirect('../');
    ...
    $employeeId = $accounts->checkEmployeeLogged();
        ...
        <table border="1" align="center" width="100%">
                         ...
                         echo "<tr>
                          ...
                          echo "
                                ...
                                <tr>
                                   ...
                                   $completeRemarksId = $remarks->isEmployeeRemarkAvailiable($employeeId, $date);
                                   foreach ($completeRemarksId as $value) {
            ...
            <tr>
            	<td colspan="2" align="center"><br />
                    <input type="button" onclick="window.location'./salary_slipp.php?date=<?php echo $date; ?>'" value="Print Salary Slip" /><br />
                </td>
            </tr>
        </table>
      </div>
