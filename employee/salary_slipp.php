<?php
    ...
    if(isset ($_GET['date'])){
        ...
        $accounts->redirect('./employee_salary.php');


    if(!$accounts->isSalaryDataAvailiable($date))
    	$accounts->palert("No Salary Data Exists For The Given Month. Please Select Another Month", "./employee_salary.php");
    	    
    $completeEmployeeId = array();

    array_push($completeEmployeeId, $accounts->checkEmployeeLogged());
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="window.print()">
		...
		<?php 
			...
			if ($flag)
				$accounts->palert("No Salary Data Exists For The Given Employees, Please Select Another", "./employee_salary.php");
		?>		
	</body>
</html>