<?php
    ...
    if(!$bank->checkEmployeeLogged())
        $bank->redirect('../');
        
    $employeeId = $bank->checkEmployeeLogged();
    ...
    <div class="main">
      <div class="content">
        <table align="center" border="0" width="100%">
        	<tr>
            	<td align="center"><h2>DISPLAYING BANK / BASIC SALARY INFORMATION</h2><hr size="2" /><br /></td>
            </tr>
        	...
        	<tr>
				...
				<?php 
			        ...
			        echo "
			            ...
			            <tr>
			                <td colspan=\"3\" height=\"40px\" align = \"center\"><hr size=\"1\" /><br /><font class = \"error\">Salary Account Information</font><br /><br /><hr size=\"1\" /><br /></td>
			            </tr>
			            <tr>
