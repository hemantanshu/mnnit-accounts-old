    ...
    <div class="main">
      <div class="content">
        <table align="center" border="0" width="100%">
        	<tr>
            	<td align="center"><h2>DISPLAYING ALLOWANCE / DEDUCTION INFORMATION</h2><hr size="2" /><br /></td>
            </tr>
        	<?php 
				...
				echo "
		            <table border=\"0\" align=\"center\" width=\"100%\">
		                ...
		                <tr>
		                    <td colspan=\"4\" height=\"5px\"><hr size=\"2\" /></td>
		                </tr>";
		            ...
		            foreach ($masterSalaryId as $accountSubhead){
		                ...
		                echo "
		                    <tr>
		                        ...
		                        <td align=\"left\" style=\"padding-left:10px\">".$accountHead->getAccountHeadName($allowance->getAllowanceAccountHead($salaryDetails[4]))."</td>";
		                if($salaryDetails[6] == 'c'){
		                    $dependentType = "Credit";
		                    echo "<td align=\"left\"><font class=\"green\">Rs. ".abs($salaryDetails[5])."</font></td>
		                          <td align=\"center\"><font class=\"green\">".$dependentType."</font></td>";
		                }
		                else{
		                    $dependentType = "Debit";
		                    echo "<td align=\"left\"><font class=\"error\">Rs. ".abs($salaryDetails[5])."</font></td>
