      ...
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            <?php 
            	...
            	if($loanIds){
	            	...
	            	foreach ($loanIds as $loanId){
                        ...
                        <tr>
                        	<th align=\"center\" colspan=\"6\"><br /><input type=\"button\" value=\"Get Statement Of This Loan\" style=\"width:300px\" onclick=\"window.location='./employee_gpfv.php?id=$loanId'\" /></th>
                        </tr>";
	            	}
	            	echo "
				            		</table>
            ...
            <?php 
            	...
            	if ($flag)
            		$gpfTotal->palert("No GPF Loan Record Exists", './');
            ?>                                       
            <tr>
            	<th ><br /><hr size="3" /><br /></th>
            </tr>
