...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
                	...
                	<table align="center" width="100%" border="0">
                        ...
                        <tr>
                        	<td colspan="7" align="center">
                            	<input type="button" value="Get The Print Statement" onclick="window.location='salary_gpfp.php'" style="width:200px" />&nbsp;&nbsp;&nbsp;
                                <input type="button" value="Get Output In Excel" onclick="window.location='salary_gpfe.php'" style="width:200px" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
      ...
      <div class="sidenav">
      	<hr size="2" /><center>
        <font color="#FF0000" size="+1"><b><?php echo $personalInfo->getName();  ?></b></font></center>
       	<hr size="2" /><br />
