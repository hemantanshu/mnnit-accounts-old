...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		<title>Complete GPF Loan Statement</title>
	...
	<body onload="window.print() ">            
    	<form action="./employee_gpfle.php" method="post">
        ...
        <div id="logout" align="center"><br />
                ...
                <input name="b3" type="button" value="Return Back" onclick="window.location='./'" style="width:200px" /> <br /><br />
		</div>	
        </form>   
	</body>
</html>
