<?php
    ...
    $personalInfo->getEmployeeInformation($loggedInfo->checkEmployeeLogged(), true);
	
	$employeeId = $personalInfo->getEmployeeId();
	$fundType = $_GET['fund'];
	$completeGpfIds = $gpfTotal->getEmployeeFundIds($employeeId, $fundType);
	if(!$completeGpfIds)
		$loggedInfo->palert("There Is No Record Availiable For The Given Employee. Please Select Another Employee", './fund_statement.php');    
...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">        	
            <tr>
            	<td align="center"><h3>COMPLETE GPF STATEMENT</h3><hr size="3" /><br /></td>
            </tr>
            <tr>
            	<td width="100%">
            	...
            	<td width="100%" align="center">
                	<table align="center" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td align="right"><font class="green"><?php echo $sumCredit; ?></font></td>
                            <td align="right"><font class="error"><?php echo $sumDebit; ?></font></td>
                            <td align="right"><font class="green"><?php echo $sumTotal; ?></font></td>
                        </tr>
                        <tr>
                        	<td height="10px"></td>
                        </tr>
                        ...
                        <tr>
                        	<td colspan="7" align="center">
                            	<input type="button" value="Get The Print Statement" onclick="window.location='salary_gpfprint.php?id=<?php echo $employeeId; ?>'" style="width:200px" />&nbsp;&nbsp;&nbsp;
                                <input type="button" value="Get Output In Excel" onclick="window.location='salary_gpfexcel.php?id=<?php echo $employeeId; ?>'" style="width:200px" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <div class="footer">@webteam.<a href="http://www.mnnit.ac.in" title="MNNIT">mnnit</a> </div>
  </div>
</div>
</body>
</html>