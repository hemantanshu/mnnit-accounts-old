    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
            	<td align="right">SELECT EMPLOYEE NAME </td>
                ...
                <td align="left">
                    ...
                    <?php 
                    	...
                    	foreach ($completeEmployeeId as $employeeId){
                    		...
                    		echo "<option value=\"$employeeId\">".$personalInfo->getEmployeeCode()." ==> ".$personalInfo->getName()."</option>";
                    	}                    		
                    ?>
                    </select></td>
            </tr>
            ...
            <tr>
                ...
                <td align="center">:</td>
                <td align="left"><input type="text" name="amount" style="width:100px" /></td>
            </tr>
            <tr>
            	<td height="20px"></td>
            </tr>
            ...
            <tr>
            	<td colspan="3" align="center">
                	<input type="submit" name="submit" value="SANCTION NEW LOAN" style="width:200px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
