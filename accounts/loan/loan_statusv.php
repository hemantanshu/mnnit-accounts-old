<?php
    ...
    if(!$completeLoanId)
    	$loan->palert("No Loan Statement Record Exists For The Given Month.", './loan_status.php');    
...
<div class="contentlarge">
      	<form action="./loan_statuse.php" method="post">      	
        <table align="center" border="0" width="100%">       	
        	<tr>
            	<th align="center" colspan="7">SHOWING LOAN STATEMENT REPORT FOR <?php echo $loan->getNumber2Month(substr($month, 4, 2)).", ".substr($month, 0, 4);?></th>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<th width="25%" align="left">Loan Name</th>
            	...
            	foreach ($completeLoanId as $loanInstallmentId){
            		...
            		echo "
						<tr>
							...
							<th align=\"left\">".$loanTypeDetails[2]."</th>
							<th align=\"right\">".number_format(abs($details[2]), 2, '.', '')."</th>
							<th align=\"right\">".number_format($loan->getLoanPrincipleAmountLeft($details[1], $month), 2, '.', '')."</th>
							<th align=\"right\" style=\"padding-right:15px\">".$loan->getLoanInstallmentLeft($details[1], $month)."</th>                
						</tr>	          
						<tr>
							<td height=\"5px\"></td>
						</tr>";
            ...
            <tr>
            	<td colspan="7" align="center"><br />
                        ...
                        <input type="button" style="width:250px" value="Print The Report" onclick="window.location='./loan_statusp.php?date=<?php echo $month; ?>'"/>&nbsp;&nbsp;&nbsp;&nbsp;
