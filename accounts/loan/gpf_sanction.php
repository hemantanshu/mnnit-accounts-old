...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
      	<form action="./gpf_sanctionc.php" method="post">
        <table align="center" border="0" width="100%">
      		<tr>
            	<td colspan="3" align="center"><h2>NEW GPF LOAN SANCTION MODULE</h2><hr size="2" /><br /><br /></td>
            </tr>      
            <tr>
            ...
            <tr>
                ...
                <td align="left">
                		<select name="type" style="width:250px">
                        	<option value="r">REFUNDABLE LOAN</option>
                            <option value="n">NON-REFUNDABLE LOAN</option>
                        </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
            	<td colspan="3" align="center">
                	<input type="submit" name="submit" value="SANCTION NEW GPF LOAN" style="width:250px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
