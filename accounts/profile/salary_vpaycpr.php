...
<head>
<title>Accounts Section -- Salary Consolidated Report For All Employees</title>
      	...
      	<table border="0" align="center" width="100%">
            ...
            <tr>
                ...
                <td align="center" width="*"><font class="bigheader">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY</font><br /><font class="smallheader">
                                                ...
                                                ACCOUNTS SECTION </font><br />
                                                <font class="extraSmallheader">CONSOLIDATED REPORT FOR ALL EMPLOYEES FOR <?php echo $reporting->nameMonth($date); ?></font></td>
        ...
        <table align="center" border="0" width="100%">       	
            ...
            <?php
            	...
            	foreach ($completeAccountHead as $accountHeadId){
            		$amount = $reporting->getCompleteReportAmount($accountHeadId, $date);
            		if ($amount){
            			$netAmount += $amount;
            			if($amount > 0 ){
            				...
            				if ($accountHeadId == "ACH22") 
            					$collegeContribution[0] = $reporting->getCompleteCollegeContribution ("ACH22", $date);
            				if ($accountHeadId == "ACH16") 
            					$collegeContribution[1] = $reporting->getCompleteCollegeContribution ("ACH16", $date);
            				++$j;
            			}
            		}
            	}
