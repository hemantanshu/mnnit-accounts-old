    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
            	<td align="right">Select The Allowance Type</td>
                <td width="20px"></td>
                <td align="left">
                			<select name="allowance" style="width:200px">
                				...
                				<option value="deduction">Total Deduction</option>
                                       <?php
                                            ...
                                            foreach($completeAllowanceId as $value){
            ...
            <tr>
            	<td colspan="3" align="center"><br /><br /><input type="submit" name="submit" value="Process The Report Allowance Statement" style="width:300px" />&nbsp;&nbsp;<input type="button" value="Return Back" onclick="window.location='./report_sallowance.php'" /><br /><br /></td>
            </tr>
        </table>
        </form>
      </div>
