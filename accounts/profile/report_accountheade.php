...
if(isset($_POST) && count($_POST) > 0){
	...
	$reporting->redirect("./report_accounthead.php");
...
while(true){
	...
	foreach ($validMonths as $count)
		array_push($data[$i], number_format($reporting->getSalaryAllowanceInfo($employeeId, $count, $accountHeadId, $option), 2, '.', ''));
	++$i;
}
ob_end_flush();
?>
