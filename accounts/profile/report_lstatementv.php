        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
            	<td align="center" colspan="6">
                    <input type="button" value="Print Statement" style="width: 200px;" onclick="window.location='./report_lstatementp.php?loanid=<?php echo $loanAccountId; ?>'"  />&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="submit" name="submit" value="Export In Excel" style="width: 200px;" onclick="window.location='./report_lstatemente.php?id=<?php echo $loanAccountId; ?>'"  />&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button" value="Return Back" style="width: 200px;" onclick="window.location='./report_lstatement.php'"  />&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
        </table>
      </div>
