<?php
    ...
    foreach ($completeGpfIds as $individualGpfId) {
        ...
        ++$count;
        $data[$count] = array();
        array_push($data[$count], $gpfTotal->getFlagComment($details[4]));
        array_push($data[$count], $gpfTotal->nameMonth($details[3]));
...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    <input type="button" name="button" value="Return Back" onclick="window.location='./report_gstatement.php'" style="width:200px" />
      ...
      <div class="sidenav">
      	<hr size="2" />
       <center> <font color="#FF0000" size="+1"><b><?php echo $gpfTotal->getOfficerName(); ?></b></font></center>
       	<hr size="2" /><br />
