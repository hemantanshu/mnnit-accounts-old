...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
      	<form action="./employee_password1.php" method="post">
        <table align="center" border="0" width="100%">
        	<tr>
            	<td align="center" colspan="3"><h2>SELECT EMPLOYEE AND SET PASSWORD TO CONTINUE</h2><br /><br /><br /><hr size="2" /><br /><br /></td>
            </tr>
                			...
                			<select name="employee" style="width:300px">
                                            <?php
                     							...
                     							foreach ($completeEmployeeIds as $individualEmployeeId) {                     								
                     								...
                     								if ($employeeId == $individualEmployeeId)
                     									echo "<option selected=\"selected\" value=\"$individualEmployeeId\">".$personalInfo->getName()."  (".$personalInfo->getEmployeeCode()." )</option>";
                     								else 
            ...
            <tr>
                ...
                <td width="20px"></td>
                <td align="left"><input type="text" name="password" style="width:200px" /></td>
            </tr>            
            <tr>
                <td height="20px"></td>
            </tr>
            <tr>
                ...
                <td width="20px"></td>
                <td align="left"><input type="text" name="cpassword" style="width:200px" /></td>
            </tr>            
            <tr>
            	<td colspan="3" align="center"><br /><br />
                <input type="submit" name="submit" value="Change The Employee Password" style="width:300px" />&nbsp;&nbsp;&nbsp;&nbsp;
