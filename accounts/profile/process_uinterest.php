...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($error == 0){
        ...
        elseif($_POST['fundType'] == "CPF")
            ...
            $url = "./process_unps";    
        if ($type == "all")
            $department->redirect("./".$url."1.php?session=".$sessionId."&value=".$value."&type=".$type."");
        else 
             $department->redirect("./".$url."2.php?session=".$sessionId."&value=".$value."");                   
    }                                       
}                                           
...
<head>
<title>Accounts Section -- Fund Interest Unprocessing Module</title>
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
                <td align="center" colspan="5"><font class="error">Fund Interest UnProcessing Module</font><br /><hr size="2" /><br /><br /></td>
            </tr>
            <tr>
