<?php
    ...
    if(count($_POST) > 0 && $_POST['submit'] == "Confirm Dropping Of This Job"){
        ...
        while (true){
            $pendingId = $ePending->isEmployeeMasterSalaryInPendingStatus($employeeId);
            if(!$ePending->isEmployeeMasterSalaryInPendingStatus($employeeId) || !$ePending->isPendingEditable($pendingId))
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
        	<tr>
            	<td colspan="5" align="center"><font class="error">Dropping Employee Pending Account Information</font><br /><hr size="1" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td colspan="5" align="center"><input type="submit" name="submit" value="Confirm Dropping Of This Job" /></td>
            </tr>
        </table>
        </form>
      </div>
