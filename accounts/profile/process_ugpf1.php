...
if (isset($_POST['submit']) && $_POST['submit'] == "UnProcess GPF Interest"){
	...
	while (true){
		...
		if($_POST['checkbox'] == "y"){
			...
			$interest->unProcessFundInterest($employeeId, $sessionDetails[2], "gpf");
			++$i;	
		}		
	}
	$interest->palert("The GPF Interest Has Been Successfully Rollbacked", "./");
}      
    ...
    <div class="main">
      <div class="contentlarge">
        ...
        <table align="center" border="0" width="100%">
             <tr>
                <td colspan="5" align="center"><h2>UNPROCESSING GPF INTEREST</h2></td>
            </tr>                             
         	 <tr>
            	<th>SN</th>
                <th>Emp Code</th>
            ...
            <?php 
            	...
            	foreach ($completeEmployeeId as $employeeId){           		            		
            		$amount = $interest->getFundAmount($employeeId, "gpf", $sessionDetails[2], 'i');		            		
            		if (!$amount || $amount == 0)
            			continue;            		
            		$employeeName = "employee".$i;
            		$checkbox = "checkBox".$i;
            ...
            <tr>
            	<td colspan="6" align="center">
            		...
            		<input type="hidden" name="interest" value="<?php echo $interestRate; ?>"/>
            		<input type="submit" name="submit" value="UnProcess GPF Interest" style="width:250px" />
