...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if ($option == 'p')
    	$accountHead->redirect("./report_accountheadp.php?sdate=$sDate&edate=$eDate&id=$accountHeadId&type=$type&value=$value");
    else 
    	$accountHead->redirect("./report_accountheadv.php?sdate=$sDate&edate=$eDate&id=$accountHeadId&type=$type&value=$value");
    	

}elseif(!isset($_GET['sdate']) || !isset($_GET['edate']) || !isset($_GET['id']))
...
<head>
<title>Accounts Section -- Account Head Information</title>
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
        	<tr>
            	<td align="center" colspan="5"><font size="+1">For AccountHead Type :<b><?php echo $accountHeadId == "total" ? 'Total Salary' :($accountHeadId == "gross" ? "Gross Salary" : ($accountHeadId == "deduction" ? "Total Deduction" : $accountHead->getAccountHeadName($accountHeadId)));?></b><br /> And Option Selected <b><?php echo $type == 'v' ? "VIEW REPORT" : ($type == 'p' ? "PRINT REPORT" : "EXPORT TO EXCEL"); ?></b><br /> From <b><?php echo $accountHead->nameMonth($sDate); ?></b> To <b><?php echo $accountHead->nameMonth($eDate); ?></b></font></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" width="30%">
                        ...
                        <input type="hidden" name="account" value="<?php echo $accountHeadId; ?>" />
