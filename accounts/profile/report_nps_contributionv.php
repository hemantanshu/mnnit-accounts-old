...
if ( isset($_POST) && $_POST['submit'] == "Print NPS Slip" ) {
    $date = $_POST['date'];
    $accounts->redirect("./report_nps_contributionp.php?date=$date");
...
<div class="container">
        ...
        <div class="content">
            <form action="" method="post">
                <table align="center" border="0" width="100%">
                    <tr>
                        <td align="center"><font class="error">NPS Slip
                                For <?php echo $accounts->getNumber2Month(substr($date, 4, 2)); ?>
                                ,<?php echo substr($date, 0, 4); ?></font><br/>
                            <hr size="2"/>
                            <br/></td>
                    </tr>
                    <tr>
                        <td width="100%" align="center">
                            <table align="center" border="1px" width="100%">
                                <tr>
                                    ...
                                    <th>Employee Code</th>
                                    <th>Employee Name</th>
                                    <th width="100px">Employee Contribution</th>
                                    <th width="100px">College Contribution</th>
                                </tr>
                                <?php
                                $i = 0;
                                $employeeAmount = $contributionAmount = 0;
                                foreach ( $completeEmployeeId as $employeeId ) {
                                    ...
                                    $employeeAmount += $sum[0];
                                    $contributionAmount += $sum[1];
                                    ...
                                    <tr>
                                        ...
                                        <td align=\"left\"><font class=\"green\">" . number_format($sum[0], 2, '.', '') . "</font></td>
                                        <td align=\"right\"><font class=\"error\">" . number_format($sum[1], 2, '.', '') . "</font></td>
                                ...
                                echo "
                                    <tr>
                                        <td align=\"center\"><font class=\"green\">" . $i . "</font></td>
                                        <td align=\"center\" colspan=\"2\">Total Amount</td>
                                        <td align=\"right\"><font class=\"error\">" . number_format($employeeAmount, 2, '.', '') . "</font></td>
                                        <td align=\"right\"><font class=\"error\">" . number_format($contributionAmount, 2, '.', '') . "</font></td>
                                    </tr>";
                                ?>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <input type="submit" name="submit" value="Print NPS Slip" style="width:250px"/>&nbsp;&nbsp;
                            <input type="button" value="Return Back"
                                   onclick="window.location='./report_nps_contribution.php'"
    ...
    <div class="footer">@webteam.<a href="http://www.mnnit.ac.in" title="MNNIT">mnnit</a> Designed And Developed By
        Hemant Kumar Sah (B.Tech ECE 2011)
    </div>
</div>
</div>
</body>
