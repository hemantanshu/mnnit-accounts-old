...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($_POST['submit'] == "View Salary Slip Of This Employee Type"){
        $type = "employeeType";
        $value = $_POST['employeeType'];
    }
    if($_POST['submit'] == "View Salary Slip Of This Department"){
        $type = "department";
        $value = $_POST['department'];
    }
    if($_POST['submit'] == "View Salary Slip Of This Designation"){
        $type = "designation";
        $value = $_POST['designation'];
    }
    if($_POST['submit'] == "View Salary Slip Of This Employee"){
        $type = "individual";
        $value = $_POST['employeeId'];
    }
    if($_POST['submit'] == "View Salary Slip Of All Employees"){
        $type = "all";
    ...
    if($error == 0){
    	if($_POST['print'] == 1)
    		$department->redirect("./salary_slipp.php?date=".$date."&value=".$value."&type=".$type."");
    	else 
    		$department->redirect("./salary_vsalaryv.php?date=".$date."&value=".$value."&type=".$type."");	
    }
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
            	<td align="center" colspan="5"><font class="error">Please Select The Options To Get The Salary Slip Of Employee</font><br /><hr size="2" /><br /><br /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td></td>
                <td align="left"><input type="checkbox" name="print" checked="checked" value="1" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit"  style="width:250px" value="View Salary Slip Of This Employee Type" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Salary Slip Of This Department" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Salary Slip Of This Designation" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Salary Slip Of This Employee" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="View Salary Slip Of All Employees" /></td>
            </tr>
