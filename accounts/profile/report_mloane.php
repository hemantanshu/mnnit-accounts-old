<?php
    ...
    foreach ($completeLoanId as $loanInstallmentId){
        ...
        array_push($data[$count], $loanTypeDetails[2]);
        array_push($data[$count], number_format(abs($details[2]), 2, '.', ''));
        array_push($data[$count], number_format($loan->getLoanPrincipleAmountLeft($details[1], $month), 2, '.', ''));
        array_push($data[$count], $loan->getLoanInstallmentLeft($details[1], $month));
    }
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    <input type="button" name="button" value="Return Back" onclick="window.location='./report_mloan.php'" style="width:200px" />
