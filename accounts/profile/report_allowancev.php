...
{
    document.Form1.action = "./report_allowancep.php"
    document.Form1.submit();             // Submit the page
    return true;
}
</script>
      ...
      <div class="contentLarge">
        ...
        <table align="center" border="0" width="100%">
            ...
            <?php
                ...
                echo "
                	<tr>
		            	<td align=\"center\" colspan=\"$colspan\"><font class=\"error\">ALLOWANCE REPORT FOR ";
                ...
                foreach ($validMonths as $i)
                		echo "<th align=\"right\"><font size=\"1px\">".$i."</font></th>";
               	echo "
               		</tr>
			            <tr>
