...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
      	<form action="./report_mallowancea.php" method="post">
        <table align="center" style=" border-collapse:collapse" width="100%">
            ...
            <tr>
            	...
            	<input type="submit" name="submit" value="Process The Report Allowance Statement" style="width:300px" />&nbsp;&nbsp;
            	<input type="button" value="Return Back" onclick="window.location='./'" /><br /><br /></td>
            </tr>
        </table>
        </form>
      </div>
