...
if(!$department->isAdmin())
        $department->palert("Only Administrator Has The Privilege To UnProcess The Interest", "./");
...
if (isset($_POST['submit']) && $_POST['submit'] == "UnProcess CPF Interest"){
	...
	while (true){
		...
		if($_POST['checkbox'] == "y"){
			...
			$interest->unProcessFundInterest($employeeId, $sessionDetails[2], "cpf");
			++$i;	
		}		
	}
    ...
    <div class="main">
      <div class="contentlarge">
          ...
          <table border="0" align="center" width="100%">
            ...
            <tr>
                ...
                <td align="center" width="*"><font class="bigheader">MOTILAL NEHRU NATIONAL INSTITUTE OF TECHNOLOGY</font><br /><font class="smallheader">
                                                ...
                                                ACCOUNTS DEPARTMENT -- CPF INTEREST MODULE
                                                 </font></td>
        ...
        <table align="center" border="0" width="100%">
             <tr>
                <td colspan="5" align="center"><h2>UNPROCESSING CPF INTEREST</h2></td>
            </tr>                             
         	 <tr>
            	<th>SN</th>
                <th>Emp Code</th>
            ...
            <?php 
            	...
            	foreach ($completeEmployeeId as $employeeId){           		            		
            		$amount = $interest->getFundAmount($employeeId, "cpf", $sessionDetails[2], 'i');		            		
            		if (!$amount || $amount == 0)
            			continue;            		
            		$employeeName = "employee".$i;
            		$checkbox = "checkBox".$i;
            		...
            		<tr>
		                ...
		                <td align=\"right\">".number_format($interest->cpfTotalBalance($employeeId, $sessionDetails[2]), 2, '.', ',')."</td>
            ...
            <tr>
            	<td colspan="6" align="center">
            		...
            		<input type="submit" name="submit" value="UnProcess CPF Interest" style="width:250px" />
