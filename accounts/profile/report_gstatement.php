<?php
    ...
    if($_POST['submit'] == "Process The GPF Loan Statement Request"){
        $employeeId = $_POST['employee'];
        if($_POST['directPrint'] == 'y'){
        	$loggedInfo->redirect("./report_gstatements.php?id=".$employeeId."&type=p");
        }
        $loggedInfo->redirect("./report_gstatements.php?id=".$employeeId."&type=v");
    }    
    ob_end_flush();
?>
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">
        	<tr>
            	<td align="center" colspan="3"><font class="error">PLEASE SELECT THE OPTIONS FOR THE GPF LOAN STATEMENT OF EMPLOYEE</font><br /><br /><br /><hr size="2" /><br /><br /></td>
            </tr>
            ...
            <tr>
                ...
                <input type="submit" name="submit" value="Process The GPF Loan Statement Request" style="width:300px" />&nbsp;&nbsp;&nbsp;&nbsp;
