<?php
    ...
    array_push($data[1], "Installment Amount");
    array_push($data[2], "Amount Left");
    array_push($data[3], "Installment Left");
    ...
    $count = 0;
   	foreach ($completeLoanId as $loanInstallmentId){            		
        ...
        array_push($data[$count], number_format($loan->getEmployeeGpfLoanAmountLeft($loanDetails[1], $month), 2, '.', ''));
        array_push($data[$count], $loan->getEmployeeGpfLoanInstallmentLeft($loanDetails[1], $month));        
 	}
    ob_end_flush();
?>
        ...
        <table align="center" border="0" width="100%">
            ...
            <tr>
                <td colspan="3" align="center">
                    ...
                    <input type="button" name="button" value="Return Back" onclick="window.location='./report_mgpfl.php'" style="width:200px" />
