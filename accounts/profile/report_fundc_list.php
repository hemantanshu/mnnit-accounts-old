                    ...
                    <table align=\"center\" width=\"100%\" border=\"1\">
                        <tr>
                            ...
                            echo "
                                        ...
                                        <td align=\"center\">:</td>
                                        <th align=\"left\">".number_format(($interestPaidSubscription+$interestPaidContribution+$amount), 2, '.', ',')."</th>
                                    </tr>
                                    <tr>
                                        <td height=\"10px\"></td>
                                    </tr>
						...
						//				   $j = 0;
                          ...
                          //  while(true){
                            //    $month = date("Ym", mktime(0, 0, 0, substr($startMonth, 4, 2)+$j, 15, substr($startMonth, 0, 4)));
                              //  $lmonth = date("Ym", mktime(0, 0, 0, substr($startMonth, 4, 2)+1+$j, 15, substr($startMonth, 0, 4)));
                                //++$j;
                                //$showMonth = date("Ym", mktime(0, 0, 0, substr($startMonth, 4, 2)+$j, 15, substr($startMonth, 0, 4)));
                            ...
                            echo "
                                    <tr>
                                    <td align=\"right\" >Total Summary</td>
                            ...
                            $interestPaidSubscription = $interest->getFundAmount($employeeId, "cpf", $endMonth, 'im');
                            $interestPaidContribution = $interest->getFundAmount($employeeId, "cpf", $endMonth, 'ic');
