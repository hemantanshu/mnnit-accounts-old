...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($_POST['submit'] == "Remarks For This Employee Type"){
        $type = "employeeType";
        $value = $_POST['employeeType'];
    }
    if($_POST['submit'] == "Remarks For This Department"){
        $type = "department";
        $value = $_POST['department'];
    }
    if($_POST['submit'] == "Remarks For This Designation"){
        $type = "designation";
        $value = $_POST['designation'];
    }
    if($_POST['submit'] == "Remarks For This Employee"){
        $type = "individual";
        $value = $_POST['employeeId'];
    }
    if($_POST['submit'] == "Remarks For All Employees"){
        $type = "all";
    ...
    if($error == 0){
    	if($_POST['option'] == '1')
    		$department->redirect("./remarks_insert.php?date=".$date."&value=".$value."&type=".$type."");
    	else 
    		$department->redirect("./remarks_view.php?date=".$date."&value=".$value."&type=".$type."");
    	exit(0);
    }
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
            	<td align="center" colspan="5"><font class="error">Please Select The Correct Options For Remarks</font><br /><hr size="2" /><br /><br /></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td align="right">Operate On To</td>
                <td></td>
                <td align="left">Insert Remarks &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option" value="1" checked="checked" /></td>
                <td></td>
                <td align="left">View Remarks &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option" value="0" /></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit"  style="width:250px" value="Remarks For This Employee Type" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Remarks For This Department" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Remarks For This Designation" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Remarks For This Employee" /></td>
            </tr>
            <tr>
            	<td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
            	...
            	<td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Remarks For All Employees" /></td>
            </tr>
