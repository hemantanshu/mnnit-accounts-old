...
if(isset ($_POST) && count($_POST) > 0){
    ...
    if($_POST['submit'] == "Annual Statement Of This Employee Type"){
        $type = "employeeType";
        $value = $_POST['employeeType'];
    }
    if($_POST['submit'] == "Annual Statement Of This Department"){
        $type = "department";
        $value = $_POST['department'];
    }
    if($_POST['submit'] == "Annual Statement Of This Designation"){
        $type = "designation";
        $value = $_POST['designation'];
    }
    if($_POST['submit'] == "Annual Statement Of This Employee"){
        $type = "individual";
        $value = $_POST['employeeId'];
    }
    if($_POST['submit'] == "Annual Statement Of All Employees"){
        $type = "all";
    ...
    if($error == 0){
        if($_POST['fundType'] == "GPF")
            $url = "./report_fundg.php";
        elseif($_POST['fundType'] == "CPF")
            $url = "./report_fundc.php";
        else
            $url = "./report_fundn.php";            
        $department->redirect($url."?session=".$sessionId."&value=".$value."&type=".$type."");
    }                                       
}                    
...
<head>
<title>Accounts Section -- Fund Annual Statement</title>
    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">            
            ...
            <tr>
                <td align="center" colspan="5"><font class="error">Please Select The Correct Operation To Be Performed</font><br /><hr size="2" /><br /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td></td>
                <td align="left">
                    <select name="fundType" style="width:200px">
            ...
            <tr>
                ...
                <td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit"  style="width:250px" value="Annual Statement Of This Employee Type" /></td>
            </tr>
            <tr>
                <td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
                ...
                <td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Annual Statement Of This Department" /></td>
            </tr>
            <tr>
                <td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
                ...
                <td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Annual Statement Of This Designation" /></td>
            </tr>
            <tr>
                <td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
                ...
                <td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Annual Statement Of This Employee" /></td>
            </tr>
            <tr>
                <td colspan="5"><br /><hr size="1" /><br /><br /></td>
            </tr>
            <tr>
                ...
                <td width="2%"></td>
                <td align="left" width="30%"><input type="submit" name="submit" style="width:250px" value="Annual Statement Of All Employees" /></td>
            </tr>    
        </table>
        </form>
      </div>
