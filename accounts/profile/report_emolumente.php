...
<div class="clearer"><span></span> </div>
    ...
    <div class="main">
      <div class="content">
      	<form action="<?php echo $option == 'p' ? './report_emolumentp.php' : './report_emolumentv.php'; ?>" method="post">
        ...
        <thead style=" cursor:pointer">
            ...
            <?php 
            	...
            	foreach ($completeEmployeeId as $employeeId){
            		...
            		echo "
            			<tr>
			            	<th><input type=\"hidden\" name=\"$employeeName\" value=\"$employeeId\" />$count</th>
			            	<th>".$personalInfo->getEmployeeCode()."</th>
			            	<th align=\"left\">".strtoupper($personalInfo->getName())."</th>
			            	<th align=\"left\">".$department->getDepartmentName($personalInfo->getDepartment())."</th>
			            	<th><input type=\"checkbox\" name=\"$checkbox\" value=\"1\" checked=\"checked\" /></th>
			            </tr>" ;
//			            <tr>
	//		            	<td height=\"5px\"></td>
		//	            </tr>";
            ...
            <tr>
            	<td colspan="5" align="center">
                	...
                	<input type="submit" name="submit" value="GET REPORT OF THESE EMPLOYEES" style="width:250px" />&nbsp;&nbsp;&nbsp;&nbsp;
