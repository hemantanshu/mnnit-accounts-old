    ...
    <div class="main">
      <div class="content">
        ...
        <table align="center" border="0" width="100%">        	
            <tr>
            	<td align="center"><h3>COMPLETE <?php echo strtoupper($fundType); ?> STATEMENT</h3><hr size="3" /><br /></td>
            </tr>
            <tr>
            	<td width="100%">
                	...
                	<table align="center" width="100%" border="0">
                        ...
                        <tr>
                        	<td colspan="7" align="center">
                                ...
                                <input type="button" value="Return Back" onclick="window.location='salary_gpf.php'" style="width:200px" />
                                <?php 
									if($settlement)
										echo "<br /><br /><input type=\"button\" value=\"Get Settlement Report\" onclick=\"window.location='gpf_settlement.php?id=".$employeeId."&fund=gpf'\" style=\"width:400px\" />" ;
								?>
                                </td>
                        </tr>
                    </table>
