    ...
    <div class="main">
      <div class="content">
      	<table align="center" border="0" width="100%">
            ...
            <tr>
            	<td height="10px" align="center"><font class="error">Pending Allowance/deduction Job Information</font></td>
            </tr>
            <tr>
            	...
            	<td align="center" valign="top">
                	<table border="1" align="center" width="100%" >
                        ...
                        <?php
                            ...
                            if($allowance->getAllowanceIds(false)){
                                $allowanceId = $allowance->getAllowanceIds(false);
                                $j = 0;
                                foreach ($allowanceId as $value){
                                    $j++;
                                    $variable = $allowance->pendingStatus($value);
                                    echo "
                                        <tr>
                                    ...
                                    if($allowance->isPendingEditable($value))
                                        echo "
                                            <td align=\"center\"><a href=\"./allowance_edit.php?id=".$value."\" target=\"_parent\"><img src=\"../img/b_edit.png\" alt=\"edit\" /></a></td>
                                            <td align=\"center\"><a href=\"./allowance_pdrop.php?id=".$value."\" target=\"_parent\"><img src=\"../img/b_drop.png\" alt=\"delete\" /></a></td>";
                                    echo "
                                        </tr>
                                        ";
