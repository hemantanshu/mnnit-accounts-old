...
<?php
    ...
    if(isset ($_POST) && $_POST['submit'] == " Confirm Deletion Of This SubType "){
        ...
        if($allowance->dropAllowanceDependence($dependentId))
                $allowance->palert("The Subtype Dependent Has Been Successfully Dropped", "./allowance.php");
    }
    elseif(isset ($_GET['did'])){
        $dependentId = $_GET['did'];
        $allowanceDetails = $allowance->getAllowanceDependentDetails($dependentId, true);
    ...
    <div class="main">
      <div class="content">
      	...
      	<table align="center" border="0" width="100%">
            ...
            <tr>
            	<td height="10px" align="center"><h1 class="error">Delete Allowance/Deduction Dependent Information</h1></td>
            </tr>
            <tr>
            	<td height="10px"><hr size="1" /></td>
            </tr>
            <tr>
            	<td height="10px" align="center">Allowance/Deduction Type Name : <font class="green"><?php echo $allowance->getAllowanceTypeName($allowanceDetails[0]); ?></font><br /><br /></td>
            </tr>
            <tr>
            	<td align="center" valign="top">
                	<table border="1" align="center" width="100%">
                    	<tr>
                            ...
                            <td align="center"><font class="green"><?php 
                                                                        if($allowanceDetails[4] == "")
                                                                            ...
                                                                            echo $allowance->getAllowanceTypeName($allowanceDetails[4]); ?></font></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="10px"></td>
                            <td align="center"><font class="green"><?php echo $allowanceDetails[3]; ?></font></td>
                        </tr>
                        <tr>
                        	<td height="10px" colspan="5"></td>
                        </tr>
                        <tr>
                        	<td align="right"><font class="display">Dependent Type : </font></td>
                            <td width="10px"></td>
                            <td align="center"><font class="green"><?php
