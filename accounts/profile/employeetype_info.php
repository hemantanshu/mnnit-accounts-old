<?php
    ...
    if(isset ($_GET['id'])){
        ...
        if(!$employeeType->getEmployeeTypeName($employeeTypeId))
            $employeeType->palert("No EmployeeType With This Information Exists ", "./employeetype.php");
    }else
...
<table align="center" border="0" width="100%">
			<tr>
             	<td align="center"><h2 style="color:#F00">Information On : <?php echo $employeeType->getEmployeeTypeName($employeeTypeId); ?></h2></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td align="center" width="100%">
                	<table align="center" border="1"  width="100%">
                        ...
                        <?php
                            $logId = $employeeType->getPendingLogIds($employeeTypeId);
                            if(is_array($logId) && sizeof($logId)){
                                $i = 1;
                                foreach ($logId as $value){
                                    $logInfo = $employeeType->getPendingLogIdInfo($value);
                                    echo "
                                        <tr>
                                        ...
                                        <tr>
                                            <td align=\"center\"><font class=\"display\">".$employeeType->getOfficerNameNotLogged($logInfo[3])."</font></td>
                                            <td align=\"center\"><font class=\"display\">".$employeeType->getOfficerNameNotLogged($logInfo[4])."</font></td>
                                            <td align=\"center\"><font class=\"display\">".$employeeType->getOfficerNameNotLogged($logInfo[5])."</font></td>
                                        </tr>
                                        <tr>
