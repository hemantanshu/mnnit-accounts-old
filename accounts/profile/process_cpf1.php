...
if (isset($_POST['submit']) && $_POST['submit'] == "Process CPF Interest"){
	...
	while (true){
		...
		$amount = $interest->getTotalCPFInterest($employeeId, $interestRate, $sessionDetails, true, 'm');
        $amount = $interest->getTotalCPFInterest($employeeId, $interestRate, $sessionDetails, true, 'c');
		++$i;
	}
	$interest->palert("The CPF Interest Has Been Applied", "./");
}
...
<head>
<title>Accounts Section -- CPF Interest Payment</title>
      ...
      <div class="contentLarge">
        ...
        <table align="center" border="0" width="100%">
         	 <tr>
                ...
                <th align="right">CPF Amt(Subs)</th>
                <th align="right">Interest</th>
                <th align="right">CPF Amt(Cont.)</th>
                <th align="right">Interest</th>
            </tr>          
            <tr>
            ...
            <?php 
            	...
            	foreach ($completeEmployeeId as $employeeId){            		
            		$amount = $interest->getTotalCPFInterest($employeeId, $interestRate, $sessionDetails, false, 'm');            		            		
            		if (!$amount || $amount == 0)
            			continue;            		
            		$employeeName = "employee".$i;
            		++$i;
            		...
            		<tr>
		                ...
		                <td align=\"right\">".  number_format($interest->cpfTotalBalance($employeeId, $sessionDetails[2], 'm'), 2, '.', '')."</td>
		                <td align=\"right\">".number_format($amount, 2, '.', '')."</td>
                                <td align=\"right\">".  number_format($interest->cpfTotalBalance($employeeId, $sessionDetails[2], 'c'), 2, '.', '')."</td>
		                <td align=\"right\">".number_format($interest->getTotalCPFInterest($employeeId, $interestRate, $sessionDetails, false, 'c'), 2, '.', '')."</td>    
		            </tr>";            		
            	}
            ?>
            <tr>
            ...
            <tr>
            	<td colspan="7" align="center">
            		...
            		<input type="submit" name="submit" value="Process CPF Interest" style="width:250px" />
