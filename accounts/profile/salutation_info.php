<?php
    ...
    if(isset ($_GET['id'])){
        ...
        if(!$loggedInfo->getSalutationName($salutationId))
            $loggedInfo->palert("No Salutation With This Information Exists ", "./salutation.php");
    }else
...
<table align="center" border="0" width="100%">
            <tr>
             	<td align="center"><h2 style="color:#F00">Information On : <?php echo $loggedInfo->getSalutationName($salutationId); ?></h2></td>
            </tr>
            <tr>
            ...
            <tr>
            	<td align="center" width="100%">
                	<table align="center" border="1"  width="100%">
                        ...
                        <?php
                            $logId = $loggedInfo->getPendingLogIds($salutationId);
